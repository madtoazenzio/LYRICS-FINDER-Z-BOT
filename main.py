...
async def help(bot, update):
    ...
    HELP_BUTTON = InlineKeyboardMarkup([[InlineKeyboardButton("🧑‍💻 Channel", url = "https://t.me/Z_Bots"),InlineKeyboardButton("YouTube Channel 📺", url = ""https://youtube.com/channel/UCBNR3HdxF8qQUqsMtfyxojQ)]])
    await update.reply_text(
...
async def about(bot, update):
    ABOUT = "**🤖 Bot :** Lyrics Search Bot\n\n**🧑‍💻 Developer :** [MadToAzenzio](https://github.com/madtoazenzio)\n\n**💻 Channel :** @Z_Bots\n\n**☎️ Support :** @z_bots_support7 \n\n**📺 YouTube Channel :** [Debugger Boy](https://youtube.com/channel/UCBNR3HdxF8qQUqsMtfyxojQ)\n\n**⚙️ Language :** Python 3\n\n**🛡️ Framework :** Pyrogram"
    await update.reply_text(
	text=ABOUT,
	disable_web_page_preview=True,
	quote=True
...
async def sng(bot, message):
        ...
        try:
                await hy.delete()
                await Ek.send_message(chat_id, text = rpl, reply_to_message_id = message.message_id, reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("Dev 🔗 ", url = f"github.com/madtoazenzio")], [InlineKeyboardButton("🧑‍💻 Channel", url = "https://t.me/Z_Bots"),InlineKeyboardButton("Other Bots 🤖", url = "https://t.me/Z_Bots/5")]]))
        except requests.ConnectionError as exception:
        	await hy.delete()
        	await message.reply_text(f"I Can't Find A Song With `{song}`", quote = True, reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("🧑‍💻 Developer", url = f"github.com/madtoazenzio")], [InlineKeyboardButton("🧑‍💻 Channel", url = "https://t.me/Z_Bots"),InlineKeyboardButton("Other Bots 🤖", url = "https://t.me/Z_Bots/5")]]))
